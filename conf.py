...
# Cannot, today is Monday build configuration file, created by
# `ablog start` on Tue May  5 02:24:39 2020.
#
...
blog_title = u'Cannot, today is Monday'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'https://tknv.github.io/'
...
project = u'Cannot, today is Monday'
copyright = u'2020, w.tknv'
author = u'w.tknv'
